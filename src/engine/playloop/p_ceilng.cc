...
void P_AddActiveCeiling(void *data) {
    ceiling_t* c = (ceiling_t*) data;
    int    i;
...
void P_RemoveActiveCeiling(void *data) {
    ceiling_t* c = (ceiling_t*) data;
    int    i;
...
void P_ActivateInStasisCeiling(void *data) {
...
int    EV_CeilingCrushStop(void *data) {
    line_t* line = (line_t*) data;
    int        i;
    int        rtn;
